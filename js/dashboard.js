        ...
        if (cached) {
          ...
          container.innerHTML = `
            <div class="d-flex align-items-center">
              ...
              <div>
                <strong>${Number(temp).toFixed(1)}°C</strong><br>
    ...
    navigator.geolocation.getCurrentPosition(async pos => {
      ...
      try {
        ...
        container.innerHTML = `
          ...
          <div>
            <strong>${Number(payload.temp).toFixed(1)}°C</strong><br>
      ...
      const msg =
        err?.code === 1 ? 'Autorisation géoloc. refusée.' :
        err?.code === 3 ? 'Géolocalisation trop lente (timeout).' :
